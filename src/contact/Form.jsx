...
const Form = () => {
  return (
    <div className='text-white bg-[#F76900] w-[40%]   rounded-3xl flex justify-center  flex-col overflow-hidden  items-center' >
...
<textarea name="" id=""  className=' border-white border-b placeholder-white h-[50px]  bg-transparent px-2 outline-none w-[300px] text-white ' placeholder='Your Message' cols={30} ></textarea>
...
<div className="icon-container  h-[70vh] w-[30vw] rounded-[100px] bg-white relative bottom-[-13%] p-3 left-[10%]">
